...
fun Login() {
    ...
    Column(
        ...
        OutlinedTextField(
            value = userName,
            trailingIcon = { Icon(imageVector = Icons.Default.Add, contentDescription = "emailIcon") },
            onValueChange = { /*TODO*/ },
        ...
        OutlinedTextField(
            ...
            trailingIcon = { Icon(imageVector = Icons.Default.Add, contentDescription = "lockIcon") },
